...
def new shared temp-table AtualizacaoDadosCliente
    ...
    field codigo_senha as char
        ...
        field complemento_empresa as char
         ...
         field  referencias_comerciais as char 
...
def new shared temp-table EfetivaVenda
    ...
    field valor_seguro as char
    field numero_proposta_seguro as char
    field numero_titulo_seguro as char
    field numero_serie_seguro as char.
...
output to /u/bsweb/log/p2k.log append.
...
then*/
 do:
    ...
    run value("ws/p2kdes/" + vacao + ".p"). /* chama programa relativo 
...
procedure BuscaDadosContratoNf.
    ...
    run ws/p2kdes/lexml_buscacontrato.p (input varquivoentrada).
...
def var v-return-mode        as log  no-undo.
    ...
    v-return-mode = 
        TEMP-TABLE efetivavenda:READ-XML("FILE", 
                                  varquivoentrada , 
                                  "EMPTY", 
                                  ? /* v-schemapath*/ ,
                                  ? /*v-override-def-map*/ , 
...
procedure DataFuturaPagamentoPrestacao.
    ...
    run ws/p2kdes/lexml_datafutura.p (input varquivoentrada).
