...
output to /u/bsweb/log/p2kdesenv.log append.
...
then*/
 do:
    ...
    run value("ws/p2kdesenv/" + vacao + ".p"). /* chama programa relativo 
...
/*
    ...
    run value("ws/p2kdesenv/" + controle.tabela + ".p").                                                 
end.
*/
...
procedure BuscaDadosContratoNf.
    ...
    run ws/p2kdesenv/lexml_buscacontrato.p (input varquivoentrada).
...
procedure EfetivaVenda.
    ...
    run ws/p2kdesenv/lexml_efetivavenda.p (input varquivoentrada).
...
procedure DataFuturaPagamentoPrestacao.
    ...
    run ws/p2kdesenv/lexml_datafutura.p (input varquivoentrada).
